...
public class LuckyWheelView extends RelativeLayout implements PielView.PieRotateListener {
    ...
    private int mCenterImageHeight;
    ...
    private LuckyItemSelectedListener mLuckyItemSelectedListener;

    @Override
    public void rotateDone(int index) {
        if (mLuckyItemSelectedListener != null) {
            mLuckyItemSelectedListener.onLuckyItemSelected(index);
        }
    }

    public interface LuckyItemSelectedListener {
        void onLuckyItemSelected(int index);
    }

    public void setLuckyRoundItemSelectedListener(LuckyItemSelectedListener listener) {
        this.mLuckyItemSelectedListener = listener;
    }
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mCenterImageWidth = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwCenterImageWidth, (int) LuckyWheelUtils.convertDpToPixel(80f, getContext()));
            mCenterImageHeight = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwCenterImageHeight, (int) LuckyWheelUtils.convertDpToPixel(80f, getContext()));
            mCenterImage = typedArray.getDrawable(R.styleable.LuckyWheelView_lkwCenterImage);
        ...
        pielView.setmCenterImageHeight(mCenterImageHeight);
        pielView.setmCenterImageWidth(mCenterImageWidth);
